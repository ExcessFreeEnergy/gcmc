...
try:
    from . import external_potentials, gcmc_ff, gcmc_ff_molecule, potentials, read_input
except ImportError:
...
def cli(argv=None):
    ...
    """
    parser = argparse.ArgumentParser(description="Run GCMC simulations for short-ranged potentials (v1 engine).")
    parser.add_argument(
        "-in",
        "--input_folder",
        required=False,
